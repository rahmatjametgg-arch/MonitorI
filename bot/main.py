...
BOT_TOKEN = "8889061301:AAHeS_1vWRvEngCvCch9Hw7YhqGHh2QZp6I"
...
LINK_OWNER = "t.me/ceolesej"
LINK_CHANNEL = "https://t.me/officialastryx"

# ================= LOG & FORCE JOIN =================
LOG_CHANNEL_ID = -1003937740976
BOT_USERNAME   = ""   # diisi otomatis saat startup via getMe

FORCE_JOIN_CHANNELS = [
    {"username": "officialastryx", "url": "https://t.me/officialastryx", "label": "📢 Channel Info Update"},
    {"username": "astryxroom",       "url": "https://t.me/astryxroom",       "label": "💬 Group Chat"},
]

# ================= PAKASIR PAYMENT =================
PAKASIR_PROJECT = os.getenv("PAKASIR_PROJECT", "lesehcodex")
PAKASIR_API_KEY  = os.getenv("PAKASIR_API_KEY", "14Ins4cVnsGCTMkaynqU66sgMTr5GQjk")
...
def _send_backup_telegram():
    ...
    zip_name = f"BACKUPAN SC IVAS LESEH_{now_str}.zip"
